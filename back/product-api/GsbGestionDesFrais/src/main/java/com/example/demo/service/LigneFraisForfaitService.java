...
public class LigneFraisForfaitService {
    ...
    public LigneFraisForfait getLigneFraisForfaitById(Long id) {
        return ligneFraisForfaitRepository.findById(id).orElse(null);
    }

    public LigneFraisForfait createLigneFraisForfait(LigneFraisForfait ligneFraisForfait) {
        return ligneFraisForfaitRepository.save(ligneFraisForfait);
    }

    public LigneFraisForfait updateLigneFraisForfait(Long id, LigneFraisForfait ligneFraisForfaitDetails) {
